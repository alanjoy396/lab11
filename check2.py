...
# Plot the first X test images, their predicted lable, and the true true_label
...
# Grab an image from the test datasets
img = test_images[0]
print(img.shape)
...
im1_fix = ImageOps.invert(im1_fix)
im2_fix = ImageOps.invert(im2_fix)
im3_fix = ImageOps.invert(im3_fix)

im1_fix.save("im1_fix.jpg")
im2_fix.save("im2_fix.jpg")
im3_fix.save("im3_fix.jpg")

np_im1 = np.array(im1_fix)
np_im2 = np.array(im2_fix)
np_im3 = np.array(im3_fix)

new_test_images = []
new_test_images.append(np_im1)
new_test_images.append(np_im2)
new_test_images.append(np_im3)
